...
em++ -DBACKPROP_TOOLS_STEP_LIMIT=10000 -DBACKPROP_TOOLS_BENCHMARK --std=c++17 -flto -msimd128 -O3 -s WASM=1 -I$BACKPROP_TOOLS_INCLUDE_DIR -s EXPORTED_FUNCTIONS="$EXPORTED_FUNCTIONS" -s MODULARIZE=1 -s EXPORT_ES6=1 -s USE_ES6_IMPORT_META=0 -s ENVIRONMENT='web' --pre-js prejs.js -o $BACKPROP_TOOLS_BUILD_DIR/wasm_interface_benchmark.js wasm_interface.cpp
em++ --std=c++17 -flto -msimd128 -O3 -s WASM=1 -I$BACKPROP_TOOLS_INCLUDE_DIR -s EXPORTED_FUNCTIONS="$EXPORTED_FUNCTIONS" -s MODULARIZE=1 -s EXPORT_ES6=1 -s USE_ES6_IMPORT_META=0 -s ENVIRONMENT='web' --pre-js prejs.js -o $BACKPROP_TOOLS_BUILD_DIR/wasm_interface.js wasm_interface.cpp